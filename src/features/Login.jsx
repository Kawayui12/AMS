      ...
      <View style={styles.white}>
        <View style={styles.Username}>  
          <TextInput style={{
            ...
            borderWidth: 2, borderColor: '#6495ed',}} 
        ...
        <TouchableOpacity style={styles.loginButton1}>
          ...
          onPress={()=> navigation.navigate(onLogin(email,password))}>Login</Text>
        </TouchableOpacity>

        <View style={styles.frame}>
          <Text style={styles.DontHaveAnAccount}>Don't have an account?</Text>
            <TouchableOpacity style={styles.signUp1}>
              <Text style={styles.signUp2} onPress={() => navigation.navigate('CreatingAccount')}>Create an Account</Text>
          </TouchableOpacity>
        </View>
      </View>
